...
const schema = [
  ...
  },
  {
    ...
    fields: [
      ...
      { label: "Карточка 4 заголовок", selector: "#projects .portfolio-card:nth-of-type(4) h3", type: "text" },
      { label: "Карточка 4 текст", selector: "#projects .portfolio-card:nth-of-type(4) p", type: "textarea" },
      { label: "Карточка 4 изображение", selector: "#projects .portfolio-card:nth-of-type(4) img", attr: "src", type: "image" },
      { label: "Карточка 5 заголовок", selector: "#projects .portfolio-card:nth-of-type(5) h3", type: "text" },
      { label: "Карточка 5 текст", selector: "#projects .portfolio-card:nth-of-type(5) p", type: "textarea" },
      { label: "Карточка 5 изображение", selector: "#projects .portfolio-card:nth-of-type(5) img", attr: "src", type: "image" },
      { label: "Карточка 6 заголовок", selector: "#projects .portfolio-card:nth-of-type(6) h3", type: "text" },
      { label: "Карточка 6 текст", selector: "#projects .portfolio-card:nth-of-type(6) p", type: "textarea" },
      { label: "Карточка 6 изображение", selector: "#projects .portfolio-card:nth-of-type(6) img", attr: "src", type: "image" }
    ]
  },
  {
    title: "Преимущества",
  ...
  },
  {
    ...
    fields: [
      ...
      { label: "Отзыв 1 проект", selector: "#reviews .review-card:nth-of-type(1) .review-project", type: "text" },
      ...
      { label: "Отзыв 2 проект", selector: "#reviews .review-card:nth-of-type(2) .review-project", type: "text" },
      ...
      { label: "Отзыв 3 проект", selector: "#reviews .review-card:nth-of-type(3) .review-project", type: "text" },
